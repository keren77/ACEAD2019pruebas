...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 03-03-2019 a las 08:30:23
...
--
CREATE DATABASE IF NOT EXISTS `academiacead` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `academiacead`;
...
(20, '2019-03-02', 'Ingreso al sistema', 'Accediendo por el Login del sistema', 1, 1),
(21, '2019-03-02', 'Ingreso al sistema', 'Accediendo por el Login del sistema', 69, 1),
(22, '2019-03-02', 'Ingreso al sistema', 'Accediendo por el Login del sistema', 1, 1),
(23, '2019-03-02', 'Ingreso al sistema', 'Accediendo por el Login del sistema', 1, 1),
(24, '2019-03-03', 'Ingreso al sistema', 'Accediendo por el Login del sistema', 1, 1);
...
(62, 'luna', 'Luna@123', '2019-03-03 05:44:37', 'adasdaasdas', 'whfndiASNDLASLD', 'EWNFMKFKMSAD', 'asdfasdasd', 22222222, 2147483647, NULL, NULL, NULL, 'asdasdasd', 2, 1, 1, 1, 1, '2019-02-27', NULL, NULL, NULL, NULL),
(63, 'solai', 'Luna123@', '2019-03-03 07:04:36', 'prueba3', 'prueba4', 'alonzo', 'cruz', 22344480, 2147483647, NULL, NULL, NULL, 'prueba@gmial.com', 1, 2, 2, 1, 5, '2019-02-27', NULL, NULL, NULL, NULL),
(64, 'IALONZO', '$2y$10$OcK1yL0OMimhsscPVQPZKubPKFL15MyATCxIiHVNaLjX7rI6M7KpW', '2019-03-03 02:31:27', 'Irma', 'Lastenia', 'Alonzo', 'Cruz', 98904421, 2147483647, NULL, 0, NULL, 'irma.alonzo1@hotmail.com', 2, 1, 1, 3, 1, NULL, NULL, NULL, NULL, NULL),
(65, 'IALONZO1', '$2y$10$Pp24PD6bk4uWNRthiVdfhO5LC.hz6ICaMX2Qfe/Qai5LzNBidRo1G', '2019-03-03 07:06:07', 'IRMA', 'LASTENIA', 'ALONZO', 'CRUZ', 98904421, 2147483647, NULL, NULL, NULL, 'IRMA.ALONZO1@HOTMAIL.COM', 2, 1, 1, 1, 5, '2019-03-02', NULL, NULL, NULL, NULL),
(66, 'PRUEBA4', '$2y$10$t45xraf7EVJHVbTEhTM0aeotlSw21bwTLC1TjXET9n1gUQHLLJh.O', '2019-03-03 07:06:49', 'CRISTHIAN', 'ISAAC', 'AGUILAR', 'HERNANDEZ', 22344480, 2147483647, NULL, NULL, NULL, 'IALONZO@BANCATLAN.HN', 1, 1, 1, 1, 5, '2019-03-02', NULL, NULL, NULL, NULL),
(67, 'PAOCR', '$2y$10$K8Yh38HPcnodZAnywf2CJ.b0DPHTmBVorTHbHTZhUqspGxx6T4E8S', '2019-03-03 07:08:00', 'PAO', 'ORBE', 'CRUZ', '', 22345678, 2147483647, NULL, NULL, NULL, 'ALONZOLASTENIA@GMAIL.COM', 1, 1, 1, 1, 5, '2019-03-02', NULL, NULL, NULL, NULL),
(68, 'ELIAS1', '$2y$10$Oqe6Mqo3857Nu/9qtLIc3e.3295wnfZIXolk3y82jA.NQ2mwZKmx6', '2019-03-03 07:07:28', 'ELI', 'EZEQUE', 'ALONZO', '', 22344456, 2147483647, NULL, NULL, NULL, 'alonzolastenia@gmail.com', 1, 2, 1, 1, 5, '2019-03-02', NULL, NULL, NULL, NULL),
(69, 'PRUEBA5', '$2y$10$q3rbtu3pTbUEcZruSmn40uGmZQGvREK5Mwrjyojcy2WVNawXUrNxy', '2019-03-03 07:05:30', 'PRUEBA5', 'GOLA', 'HALF', '', 2222222, 345678920, NULL, 0, NULL, 'alonzolastenia@gmail.com', 1, 2, 1, 3, 5, '2019-03-02', NULL, NULL, NULL, NULL),
(70, 'PRUEBAS6', '$2y$10$zOdFdMjXW7/IsDYoEJ4U7OQ61vVuUVDxn66pP7P/5LDxLn7Wtxlj6', '2019-03-03 05:05:00', 'PRUEBA', '', 'PRUEBA', '', 0, 0, NULL, 0, NULL, 'prueba@gmail.com', 1, 1, 1, 1, 5, '2019-03-02', NULL, NULL, NULL, NULL),
(71, 'PRUEBA7', '$2y$10$gPNvTMSqUM17te1H.mbZ0eKcEYNN2qvgDQnAUJ/IIkI2kXThiut.2', '2019-03-03 07:25:54', 'PRUEBA7', '', 'PRUEBA', '', 0, 0, NULL, 0, NULL, 'prueba@gmail.com', 1, 2, 1, 1, 5, '2019-03-03', NULL, NULL, NULL, NULL);
...
('root', '[{\"db\":\"academiacead\",\"table\":\"tbl_usuarios\"},{\"db\":\"academiacead\",\"table\":\"tbl_roles\"},{\"db\":\"academiacead\",\"table\":\"tbl_secciones\"},{\"db\":\"academiacead\",\"table\":\"tbl_preguntasusuario\"},{\"db\":\"academiacead\",\"table\":\"tbl_personal\"},{\"db\":\"academiacead\",\"table\":\"tbl_matricula\"},{\"db\":\"academiacead\",\"table\":\"tbl_periodoacademico\"},{\"db\":\"academiacead\",\"table\":\"tbl_modalidades\"},{\"db\":\"academiacead\",\"table\":\"tbl_clases\"},{\"db\":\"academiacead\",\"table\":\"tbl_tipocontacto\"}]');
...
('', '2018-10-17 04:27:09', '{\"lang\":\"es\"}'),
('root', '2019-03-03 07:29:31', '{\"lang\":\"es\",\"Console\\/Mode\":\"collapse\",\"NavigationWidth\":283}');
