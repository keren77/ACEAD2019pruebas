...
--
-- Host: 127.0.0.1
-- Generation Time: Feb 28, 2019 at 07:41 AM
...
INSERT INTO `tbl_alumnos` (`Id_Alumno`, `PrimerNombre`, `SegundoNombre`, `PrimerApellido`, `SegundoApellido`, `FechaNacimiento`, `Cedula`, `Telefono`, `CorreoElectronico`, `FechaIngreso`, `Id_genero`, `Id_estadocivil`) VALUES
(1, 'ANA', 'MARIA', 'CRUZ', 'PAZ', '1976-10-10', '1008196704567', '22789044', NULL, '2018-10-10', 1, 1),
(2, 'Juan', 'PABLO', 'PINEDA', 'PONCE', '1978-12-31', '107197809360', '22780041', NULL, '2018-10-10', 2, 2),
(5, 'LUNA', 'BELLA', 'CHECK', 'PAZ', '1996-03-03', '807199608653', '22348902', NULL, '2018-10-17', 1, 2),
(6, 'NICOLE', '', 'VARELA', '', '0000-00-00', '801000000000', '11111111', NULL, '0000-00-00', 2, 1),
(7, 'NICOLE', '', 'VARELA', '', '0000-00-00', '801000000000', '11111111', NULL, '0000-00-00', 2, 1),
(8, 'LUIS', 'FERNANDO', 'ORTIZ', 'LOPEZ', '0000-00-00', '801199547856', '22213369', NULL, '0000-00-00', 2, 1),
(12, 'KEREN', '', 'YANES', '', '0000-00-00', '801199312131', '88888888', 'abc@abc.com', NULL, 1, 2),
(15, 'KEREN', '', 'YANES', '', '2011-11-11', '801199317194', '88888888', 'abc@abc.com', NULL, 1, 1),
(16, 'KERENPL', '', 'YANES', '', '0000-00-00', '1111111111111', '88888888', 'abc@abc.com', NULL, 1, 1),
(17, 'KEREN', '', 'YANES', '', '1993-08-08', '801000011111', '88888888', 'abc@abc.com', NULL, 1, 1),
(18, 'KEREN', '', 'YANES', '', '2018-08-08', '801111111111', '88888888', 'abc@abc.com', NULL, 1, 2);
...
(17, '2019-02-17', 'Ingreso al sistema', 'Accediendo por el Login del sistema', 1, 1),
(18, '2019-02-17', 'Ingreso al sistema', 'Accediendo por el Login del sistema', 1, 1),
(19, '2019-02-17', 'Ingreso al sistema', 'Accediendo por el Login del sistema', 1, 1),
(20, '2019-02-17', 'Ingreso al sistema', 'Accediendo por el Login del sistema', 12, 1),
(21, '2019-02-18', 'Seguridad en acceso', 'Agregando pregunta de seguridad', 12, 2),
(22, '2019-02-17', 'Ingreso al sistema', 'Accediendo por el Login del sistema', 12, 1),
(23, '2019-02-18', 'Seguridad en acceso', 'Agregando pregunta de seguridad', 12, 2),
(24, '2019-02-18', 'Seguridad en acceso', 'Agregando pregunta de seguridad', 12, 2),
(25, '2019-02-18', 'Seguridad en acceso', 'Agregando pregunta de seguridad', 12, 2),
(26, '2019-02-18', 'Cambio de password', 'Cambiando el password en el primer acceso del usuario', 12, 6),
(27, '2019-02-17', 'Ingreso al sistema', 'Accediendo por el Login del sistema', 1, 1),
(28, '2019-02-17', 'Ingreso al sistema', 'Accediendo por el Login del sistema', 1, 1),
(29, '2019-02-17', 'Ingreso al sistema', 'Accediendo por el Login del sistema', 28, 1),
(30, '2019-02-17', 'Ingreso al sistema', 'Accediendo por el Login del sistema', 1, 1),
(31, '2019-02-17', 'Ingreso al sistema', 'Accediendo por el Login del sistema', 1, 1),
(32, '2019-02-18', 'Ingreso al sistema', 'Accediendo por el Login del sistema', 1, 1),
(33, '2019-02-18', 'Ingreso al sistema', 'Accediendo por el Login del sistema', 1, 1),
(34, '2019-02-18', 'Ingreso al sistema', 'Accediendo por el Login del sistema', 1, 1),
(35, '2019-02-19', 'Ingreso al sistema', 'Accediendo por el Login del sistema', 1, 1),
(36, '2019-02-19', 'Ingreso al sistema', 'Accediendo por el Login del sistema', 12, 1),
(37, '2019-02-19', 'Ingreso al sistema', 'Accediendo por el Login del sistema', 15, 1),
(38, '2019-02-19', 'Seguridad en acceso', 'Agregando pregunta de seguridad', 15, 2),
(39, '2019-02-19', 'Seguridad en acceso', 'Agregando pregunta de seguridad', 15, 2),
(40, '2019-02-19', 'Seguridad en acceso', 'Agregando pregunta de seguridad', 15, 2),
(41, '2019-02-19', 'Seguridad en acceso', 'Agregando pregunta de seguridad', 15, 2),
(42, '2019-02-19', 'Ingreso al sistema', 'Accediendo por el Login del sistema', 1, 1),
(43, '2019-02-21', 'Ingreso al sistema', 'Accediendo por el Login del sistema', 1, 1),
(44, '2019-02-21', 'Ingreso al sistema', 'Accediendo por el Login del sistema', 1, 1),
(45, '2019-02-24', 'Ingreso al sistema', 'Accediendo por el Login del sistema', 1, 1),
(46, '2019-02-25', 'Ingreso al sistema', 'Accediendo por el Login del sistema', 1, 1),
(47, '2019-02-27', 'Ingreso al sistema', 'Accediendo por el Login del sistema', 1, 1),
(48, '2019-02-27', 'Ingreso al sistema', 'Accediendo por el Login del sistema', 12, 1),
(49, '2019-02-27', 'Ingreso al sistema', 'Accediendo por el Login del sistema', 12, 1),
(50, '2019-02-28', 'Ingreso al sistema', 'Accediendo por el Login del sistema', 1, 1),
(51, '2019-02-28', 'Ingreso al sistema', 'Accediendo por el Login del sistema', 1, 1),
(52, '2019-02-28', 'Ingreso al sistema', 'Accediendo por el Login del sistema', 1, 1),
(53, '2019-02-28', 'Ingreso al sistema', 'Accediendo por el Login del sistema', 1, 1);
...
('COCO', 12, 1, '2019-02-18', '2019-02-18', 'Autoregistro', 'Autoregistro'),
('KEREN', 12, 4, '2019-02-18', '2019-02-18', 'Autoregistro', 'Autoregistro'),
('MORADO', 12, 5, '2019-02-18', '2019-02-18', 'Autoregistro', 'Autoregistro');
...
(1, 'ADMIN', '$2y$10$KBv7ZLSMURl3ipU0f03lFu.vZ435MhsnNh0upmRjPDiZaKptU8Ht.', '2019-02-28 06:40:01', 'Administrador', NULL, '', NULL, 0, 0, 0, 1, '2020-12-31', 'admin@admin.com', 0, 0, 0, 3, 1, '2018-10-22', '2018-10-22', 'adminsis', 'adminsis', NULL),
...
(12, 'ZIMBO', '$2y$10$dBm4OdMp1NMQvJC1kMGWE.Fzl7c/EQRpY5oEplnJVXh01HmQPwPf.', '2019-02-28 05:38:50', 'Zimbo', '', 'Castilla', '', 88888888, 801000011111, 0, 0, '2018-12-17', 'kyanes917@gmail.com', 1, 1, 2, 3, 4, '2018-11-17', '2018-11-17', 'Autoregistro', NULL, NULL),
(15, 'SILVITA', '$2y$10$b71y0mcZPI1ZXOH96IHNXugJdXsRI1egVdginLzegXAeDCW1x8d4e', '2019-02-19 07:20:05', '', NULL, '', NULL, 0, 0, 0, 0, '2018-12-18', 'kyanes917@gmail.com', 0, 0, 0, 3, 4, '2018-11-18', '2018-11-18', 'Autoregistro', NULL, NULL),
...
(23, 'irma1', '$2y$10$4ijEnaKrn7C/olsEbPyWB.AN71v2AT0ner452sR4M3ALXBE2B1r0O', '2019-02-14 05:09:54', 'Irma', 'Lastenia', 'Alonzo', 'P', 99999999, 801111111111, 0, NULL, '2019-02-02', 'irma.alonzo1@hotmail.com', 1, 1, 1, 2, 3, '2018-12-01', '2018-12-01', 'Autoregistro', NULL, NULL),
(28, 'KEREND', '$2y$10$kpLQngXMBZiDnuXzVZEFxOZIInbfZuEI2tOzoUisT4.oZSNfIChFO', '2019-02-18 04:32:22', 'KEREN', '', 'YANES', '', 11111111, 801000011111, NULL, 0, NULL, 'abc@abc.com', 1, 1, 1, 3, 2, NULL, NULL, NULL, NULL, NULL),
(29, 'KERENY', '$2y$10$IE14GG/o4UpUjC9fLlpsW.FnMzkCw6hPFvEdvTejFiS27lqTBsixq', '2019-02-28 06:37:15', 'KEREN', '', 'YANES', '', 88888888, 8010000111111, NULL, 0, NULL, 'abc@abc.com', 1, 1, 1, 3, 3, NULL, NULL, NULL, NULL, NULL),
(30, 'KERENT', '$2y$10$sQdftb5HoYZl85G5C4FpreSbvnqmEXnzx8FPnBBZHizG3Lu/bcRvu', '2019-02-28 06:40:19', 'KEREN', '', 'YANES', '', 88888888, 801000011111, NULL, 0, NULL, 'abc@abc.com', 1, 1, 1, 3, 4, NULL, NULL, NULL, NULL, NULL);
...
--
ALTER TABLE `tbl_bitacora`
  MODIFY `Id_Bitacora` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=54;
